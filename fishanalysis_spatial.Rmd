...
for (m in unique(stats.all$Model)) {
    ...
    g1 <- stats.all.sum %>%
        ...
        scale_x_discrete('Responses',position='top') +
    ...
    ggsave(filename=paste0('output/figures/spatial.heatmap_',m,'.png'), g1, width=13, height=10, dpi=300)
    ggsave(filename=paste0('output/figures/spatial.heatmap_',m,'.pdf'), g1, width=13, height=10)
